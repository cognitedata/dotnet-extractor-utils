...
namespace Cognite.Extensions
{
    ...
    public sealed class DeleteError
    {
        ...
        /// </summary>
        public IEnumerable<IIdentity> IdsNotFound { get; }
        ...
        /// </summary>
        public IEnumerable<IIdentity> IdsDeleteNotConfirmed { get; }
        ...
        public DeleteError(IEnumerable<IIdentity> idsNotFound, IEnumerable<IIdentity> idsDeleteNotConfirmed)
        {
